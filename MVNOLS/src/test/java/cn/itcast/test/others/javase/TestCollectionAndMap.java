...
import cn.itcast.test.others.javase.TestArray.DescComparator;
...
//		Map<String, String> map = new LinkedHashMap<String, String>();
		...
		System.out.println("Use key + foreach to traverse a map:");
		...
		System.out.println("Use entry + foreach to traverse a map:");
	...
	public void testCollectionsClass () throws Exception {
		...
		Collections.sort(integerList, descComparator);
		...
		int indexInDescOrder = Collections.binarySearch(integerList, elementForIndex, descComparator);
