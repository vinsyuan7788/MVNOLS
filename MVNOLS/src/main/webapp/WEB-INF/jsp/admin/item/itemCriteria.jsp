...
<html>
  <head>
    <title>Advanced search page for item</title>
...
$().ready(function () {
	...
	$("#query").click(function () {
		...
		$("#criteriaForm").attr("action", "<c:url value = '/itemPagination/queryItemListByAdminCriteria.action'/>").attr("method", "get").submit();
	});
});
</script>
  <body>
