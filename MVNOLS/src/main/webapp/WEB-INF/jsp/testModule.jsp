...
<html>
  <head>
    <title>This page is for testing of action classes</title>
...
$().ready(function () {
	...
	$("#queryUser").click(function () {
		window.location.href = "<c:url value = '/user/queryUser.action'/>?id=1";
	});
	$("#query").click(function () {
		if ($("#choose_id").val() == 0) {
			...
			$("#queryForm").attr("action", "<c:url value = '/user/queryUser.action'/>").attr("method","post").submit();		
		}
	});
