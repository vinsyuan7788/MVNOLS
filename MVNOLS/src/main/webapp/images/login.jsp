...
<html>
  <head>
    <title>http://localhost:8080/OLS/login.jsp</title>
...
//				remote: "<c:url value = '/userajax/existenceValidation.action'/>"
			...
			captcha: {
				required: true,
				remote: "<c:url value = '/userajax/captchaValidation.action'/>"
			}
		},
...
<div id="main">
<form class="cmxform" id="loginForm" method="post" action="<c:url value = '/user/userLogin.action'/>">
	<fieldset>
